...
import com.licon.accmanager.authentication.AccountGeneral;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button mButtonGetAuthToken;
    private Button mButtonGetAuthTokenConvenient;
    private Button mButtonInvalidateToken;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonAddAccount = (Button) findViewById(R.id.btnAddAccount);
        mButtonGetAuthToken = (Button) findViewById(R.id.btnGetAuthToken);
        mButtonGetAuthTokenConvenient = (Button) findViewById(R.id.btnGetAuthTokenConvenient);
        mButtonInvalidateToken = (Button) findViewById(R.id.btnInvalidateAuthToken);

        mButtonAddAccount.setOnClickListener(this);
        mButtonGetAuthToken.setOnClickListener(this);
        mButtonGetAuthTokenConvenient.setOnClickListener(this);
        mButtonInvalidateToken.setOnClickListener(this);
